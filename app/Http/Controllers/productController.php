    ...
    {   
        ...
        if(isset($validatedData['title'])){
            ...
            // Store product image and content
             ...
             \Storage::disk('s3')->putFileAs($livre_image_aws_storage_path, $validatedData['image']);
             \Storage::disk('s3')->putFileAs($livre_content_aws_storage_path, $validatedData['livre']);
